...
#4write a python script to print "Hello Python" on the screen using visual studio code
print("Hello python")
...
a="Soumik"
print(a)
#9write a python script to print the value of a variable to store your name, age, Qualificatiion, years of experience and print it.
name='soumik'
age='17'
qualification='class12'
print(name,age,qualification)

#10write a python script to print value of three variables, each in a new line. Variable contains integer values.
a=24
b=14
c=45
print(a,b,c,sep="\n")
